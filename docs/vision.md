...
4. **Avant upload** vers Vigie-Chiro, chaque fichier doit :
   ...
   - **et pour les détecteurs full-spectrum (AudioMoth, SM4, etc.)** être expansé temporellement ×10 (lossless, réécriture du sample rate) puis découpé en fichiers de 5 secondes réelles (= 50 s d'audio expansé) — étapes habituellement réalisées dans Kaleidoscope.
